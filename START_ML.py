...
glm_metrics_df.T.to_csv("glm_metrics_all.csv")
rf_metrics_df.T.to_csv("rf_metrics_all.csv")
gbm_metrics_df.T.to_csv("gbm_metrics_all.csv")
en_metrics_df.T.to_csv("en_metrics_all.csv")
multiglm_metrics_df.T.to_csv("multiglm_metrics_all.csv")
